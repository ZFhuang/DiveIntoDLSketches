...
# 卷积后的行长n-k+p+1=8-5+2*2+1=8
# 卷积后的列长n-k+p+1=8-3+1*2+1=8
print(comp_conv2d(conv2d, X).shape)
print('————————————————————————————')
...
# 除不完的情况，默认向下取整
# 卷积后的行长(n-k+p+s)/s=(8-3+0+3)/3=取2
# 卷积后的列长(n-k+p+s)/s=(8-5+1+4)/4=2
print(comp_conv2d(conv2d, X).shape)