...
SAVE_PATH = rootPath+r'/Models/SRDenseNet_'+computer_name+r'_'+format_time+r'.pth'
LOAD_PATH = rootPath+r'/Models/SRDenseNet_ZFH_2021-03-31_19-19-14.pth'
...
# 初始化网络
net = SRDenseNet(scale=ratio, dense_input_chan=16, growth_rate=16, bottleneck_channel=64, num_dense_conv=3, num_dense=2)
# net = SRDenseNet(scale=ratio)
