...
SAVE_PATH = rootPath+r'/Models/RED_'+computer_name+r'_'+format_time+r'.pth'
LOAD_PATH = rootPath+r'/Models/RED_ZFH_2021-03-27_16-35-58.pth '
...
# 训练参数
net = RED(ratio=2, num_feature=32, num_con_decon_mod=5, filter_size=3, skip_step=2)
print(net)
