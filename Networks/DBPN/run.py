...
ROOT_FOLDER = dataPath+r'/datasets/Set14/'
...
SAVE_PATH = rootPath+r'/Models/DBPN_'+computer_name+r'_'+format_time+r'.pth'
LOAD_PATH = rootPath+r'/Models/DBPN_ZFH_2021-03-31_19-19-14.pth'
...
# 初始化网络
net = Dense_DBPN(in_channel=1, scale=2, num_pair=3,
                 num_filter=48, grow_rate=32)
